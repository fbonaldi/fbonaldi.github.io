...
Subjects covered: normed spaces, multilinear applications, continuity, differentiability, local extrema, $C^1$
functions, diffeomorphisms, local inversion, implicit functions.
